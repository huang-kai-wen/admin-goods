...
export default {
  ...
  inputBlur:function(errorItem,inputContent){
                ...
                if (this.formName.username != '' && this.formName.password != '' && this.formName.picbase64 != '' && this.formName.job != '') {
     ...
     submitForm:function(formName){
            if( sessionStorage.admins=="aokxf"){
              ...
              this.$store.dispatch('adminmutation',formName)
            }
